...
symptom_list = [
    ...
    'whiplash', 'carpal tunnel syndrome', 'sinus pressure', 'headache', 'eczema', 'psoriasis', 'hives', 'impetigo',
    ...
    'nail discoloration', 'nail brittleness', 'nail separation', 'nail ridges', 'nail pitting', 'nail thickening', 'nail splitting',
    'nail fragility', 'nail fungus', 'nail psoriasis', 'nail lichen planus', 'nail melanonychia', 'nail leukonychia',
    'nail onychomycosis', 'nail paronychia', 'nail green nail syndrome', 'nail clubbing', 'nail concave nails', 'nail convex nails',
    'nail horizontal ridges', 'nail vertical ridges', 'nail spoon nails', 'nail trachyonychia', 'nail dystrophy', 'joint instability',
    ...
    'ear dryness', 'ear fullness', 'ear congestion', 'ear fluid', 'ear wax buildup', 'ear infection', 'tinnitus', 'balance disorder','chills',
...
symptom_synonyms = {
    ...
    'headace' : ['head pain', 'throbbing headache', 'pounding head', 'splitting headache', 'severe headache', 'migraine-like ache', 'cranial ache', 'head pressure', 'sinus headache', 'tension headache', 'hammering pain in skull', 'aching brain', 'full-head ache', 'temple-throbbing pain', 'dull ache behind eyes', 'stabbing head sensation', 'skull-crushing pressure', 'nagging ache in head', 'relentless cranial pounding', 'forehead-tightening discomfort', 'vice-like grip on head', 'pulsating headache', 'dull throb', 'piercing head agony', 'continuous headache hum', 'low-level head strain', 'top-of-head soreness', 'subcranial ache', 'stabbing darts of pain in scalp', 'brain-squeezing feeling', 'top-heavy ache', 'ear-to-ear head ache', 'all-encompassing head discomfort', 'band-like pressure around head', 'persistent noggin ache', 'head tenderness', 'scalp-aching feeling', 'sensitive head region', 'brainache', 'mind-throbbing torment', 'front-lobe pressure', 'crown-of-head tension', 'behind-the-eyes ache', 'skull-tight discomfort', 'never-ending head throb', 'grating ache inside skull', 'sinus-pressured ache', 'temple pounding', 'brain pulsation pain', 'cephalic torment', 'oppressive ache under cranium', 'subtle persistent ache', 'gnawing head discomfort', 'dull pounding drumbeat in head', 'hammering inside skull walls', 'unyielding head tension', 'rote ache cycling through head', 'cranium under siege', 'deep-set head pang', 'swirling headache sensation', 'anchor-like pressure in head'],
    'migraine': ['Intense one-sided headache', 'migraine aura', 'pulsating pain in head', 'photophobia-associated headache', 'debilitating headache', 'migraine attack', 'searing half-skull ache', 'throbbing temple migraine', 'nausea-laced head pain', 'light-sensitive head torture', 'migraine episode', 'crippling one-sided ache', 'migraine spike', 'aura-triggered headache', 'piercing localized head pain', 'migraine storm', 'skull-splitting half-side ache', 'throbbing migraine pulse', 'debilitating cranial assault', 'severe sensory headache', 'disabling one-sided throb', 'catastrophic temple pounding', 'migraine-induced nausea', 'half-head agony', 'sharp lancing head pain', 'visual disturbance headache', 'searing localized ache', 'migraine-driven incapacity', 'intense beam of pain behind one eye', 'rhythmic migraine pounding', 'brain-splitting side ache', 'overwhelming migraine pressure', 'incapacitating headache event', 'shattering unilateral head pain', 'sensitive to slightest sound', 'migraine meltdown', 'severe sensitivity headache', 'hammering half-head ache', 'aura shimmer leading to pain', 'throbbing unilateral agony', 'needle-like head stab', 'crushing half-skull sensation', 'crippling light-triggered pain', 'migraine climate inside head', 'tidal wave of head torment', 'migraine crescendo', 'migraine-flare crisis', 'incapacitating halo of pain', 'ear-to-temple throbbing on one side'],
    'allergies': ['allergy', 'allergic reaction', 'allergic response'],
    'fever':['high temperature', 'elevated body temperature', 'feeling feverish', 'fevering', 'running a fever', 'burning up', 'feeling internally hot', 'having a temperature', 'spiking a fever', 'febrile state', 'raised core temperature', 'overheated body', 'intense body heat', 'thermal imbalance', 'body overheating', 'raging fever', 'heated condition', 'abnormally warm body', 'pyrexia', 'uncontrolled internal heat', 'feeling aflame', 'body heat surging', 'hot to the touch', 'internal ignition of warmth', 'body temperature surging', 'excessive warmth inside', 'bodily heat overload', 'intense flush', 'thermometer reading high', 'scorching internal climate', 'burning sensation from within', 'sweltering body feel', 'thermal elevation', 'heated bloodstream', 'furnace-like feeling', 'feeling like an oven', 'heat radiating under skin', 'smoldering inside', 'inflamed sensation', 'uncomfortably hot', 'oppressive internal heat', 'blistering warmth', 'torrid internal state', 'simmering body temperature', 'stifling heat', 'too hot all over', 'internal fire', 'ignited from the inside', 'excessive internal warmth', 'body boiling over', 'incendiary sensation', 'intense internal glow', 'unrelenting heat', 'scorching from the inside out', 'blazing warmth', 'molten interior heat', 'near boiling point', 'incapacitating heat', 'relentless feverishness', 'sizzling body temp', 'flaming sensation', 'constant burning feeling', 'heat wave inside me', 'sweating due to internal heat', 'red-hot core', 'smoldering embers of warmth', 'furnace-like core', 'pulsating heat', 'unremitting temperature rise', 'searing body condition', 'oppressive feverishness', 'baked from within', 'overheated system', 'fire coursing through veins', 'endlessly hot', 'elevated reading on the thermometer', 'no relief from heat', 'intense internal burning', 'volcanic warmth', 'torched from inside', 'superheated body', 'radical temperature spike', 'roasting sensation', 'tropical internal climate', 'heat-induced misery', 'stoked internal fires', 'hothouse conditions inside', 'stifling fever fire', 'blazing internal inferno', 'relentless temperature climb', 'fever-driven meltdown', 'luminous internal heat', 'unquenchable body heat', 'feeling like molten lava inside', 'heat haze emanating from body', 'fiery torment', 'scorching bloodstream', 'body temp off the charts', 'relentless thermal surge', 'raging internal furnace'],
    'cough': ['Persistent cough', 'hacking cough', 'dry cough', 'wet cough', 'productive cough (with phlegm)', 'barking cough', 'non-productive cough', 'chronic cough', 'coughing up mucus/sputum/blood', 'irritating cough', 'scratchy cough', 'whooping cough-like sound', 'continuous throat clearing', 'raspy hacking', 'chesty cough', 'rattling cough', 'deep-chested cough', 'shallow annoying cough', 'tickling cough', 'lingering throat hack', 'spasm-like coughs', 'throaty expulsions', 'worrisome coughing fits', 'repetitive cough bursts', 'phlegmy hacking', 'bronchial coughing'],
    'sore throat': ['throat pain', 'scratchy throat', 'painful throat'],
    'stomach ache': ['stomach pain', 'abdominal pain', 'belly ache'],
    'fatigue': ['tiredness', 'extreme tiredness', 'exhaustion'],
    'nausea': ['feeling nauseous', 'upset stomach', 'queasy'],
    'dizziness': ['Lightheadedness', 'feeling faint', 'woozy sensation', 'spinning feeling', 'off-balance', 'unsteady', 'dizzy spells', 'giddy feeling', 'vertiginous sensation', 'wobbly feeling', 'swaying in mind', 'head swimming', 'feeling as if room is turning', 'disoriented equilibrium', 'teetering sense', 'tipsy sensation without alcohol', 'floating head', 'unstable ground feeling', 'swirling environment', 'sense of being on a boat', 'nauseating spin', 'loss of spatial orientation', 'drifting balance', 'feeling like I might topple', 'wavy floor sensation', 'heady unsteadiness', 'murky equilibrium', 'airy head sensation', 'constant near-tip-over feeling', 'mental wobble', 'feathery balance', 'gravity shifting under feet', 'dizziness waves', 'rocking sensation', 'seasick feeling on land', 'fuzzy-headed instability', 'inner ear imbalance feeling', 'wavy-field-of-view sensation', 'lurching environment', 'faltering steadiness', 'delicately balanced but slipping', 'rubbery legs feeling', 'giddy swirl in head'],
    'shortness of breath': ['Shortness of breath', 'breathlessness', 'difficulty breathing', 'feeling air hunger', 'rapid breathing', 'fast breathing', 'shallow breathing', 'gasping for air', 'labored breathing', 'struggling to breathe', 'tightness in chest while inhaling', 'feeling suffocated', 'can’t catch my breath', 'panting heavily', 'air feeling thin', 'lungs working overtime', 'chest feels restricted', 'fighting for each breath', 'wheezing for air', 'strained respiration', 'feeling smothered', 'desperate for oxygen', 'winded easily', 'constant puffing', 'breathing feels blocked', 'inhaling with effort', 'forced breathing', 'constant need to gulp air', 'sensation of drowning in open air', 'chest heaviness on breathing', 'incomplete lung expansion', 'inadequate airflow', 'lungs not filling properly', 'needing to breathe harder', 'stuck in half-breath', 'breath cut short', 'huffing and puffing', 'shallow panting', 'frantic search for air', 'hyperventilating feeling', 'feeling as if air is too thick', 'minimal air exchange', 'muscle effort just to breathe', 'chest oppression', 'suffocating sensation even in open space', 'feeling strangled by lack of air', 'restrictive breathing pattern', 'breathing feels like pushing through a straw', 'air-starved lungs', 'cannot take a deep breath', 'strained oxygen intake', 'feeling like each breath is a struggle', 'never fully satisfied inhalation', 'gasping between words', 'needy breathing pattern', 'barely pulling in enough air', 'lungs working at half capacity', 'respiratory distress', 'continuous short-windedness', 'feeling I can’t fully inflate lungs'],
    'chest pain': ['chest discomfort', 'sharp chest pain', 'tightness in chest'],
    'muscle pain': ['muscle ache', 'muscle soreness', 'muscle strain'],
    'insomnia': ['difficulty sleeping', 'trouble sleeping', 'sleeplessness'],
    'rash': ['skin rash', 'redness on skin', 'skin irritation'],
    'congestion': ['nasal congestion', 'blocked nose', 'stuffy nose'],
    'runny nose': ['nasal discharge', 'drippy nose', 'clear runny nose'],
    'sneezing' : ['Sneezing fits', 'frequent sneezing', 'sneezing spells', 'sneezing bouts', 'sneezing attacks', 'sneezing episodes', 'uncontrollable sneezing', 'explosive sneezes', 'repetitive sneezes', 'unstoppable nasal explosions', 'constant “Achoo!”', 'serial sneezing', 'sneeze after sneeze', 'chain-sneezing', 'nasal expulsions', 'nasal reflex outbursts', 'convulsive sneezing', 'rapid-fire sneezes', 'machine-gun sneezing', 'persistent nasal expulsions', 'surprise sneezes', 'itching sneeze reflex', 'tickling in nose triggering sneezes', 'staccato sneezing', 'sneeze cascades'],
    'swollen lymph nodes': ['swollen glands', 'lymph node swelling', 'enlarged lymph nodes'],
    'joint pain': ['joint discomfort', 'arthralgia', 'pain in joints'],
    'diarrhea': ['loose stools', 'frequent bowel movements', 'watery stools'],
    'vomiting': ['throwing up', 'puking', 'stomach upset'],
    'wheezing' : ['Wheezy breathing', 'whistling sound in chest', 'squeaky breath sounds', 'airway constriction noise', 'raspy inhalation/exhalation', 'high-pitched airway noise', 'strained breathing sounds', 'pipe-like whistling in lungs', 'shrill breathing tone', 'whistle-like wheeze', 'tight-sounding inhalation', 'air squeaking through narrow passages', 'wheezy rasp', 'reedy airway noise', 'restricted airflow whistling', 'hissing breath', 'airy shrillness', 'squealing lung sounds', 'sinusoidal airway noise', 'faint whistling undertone', 'discordant breathing note', 'squeaky bronchial sound', 'flute-like chest murmur', 'feeble airy gasp', 'throttled breathing noise', 'subtle wind-through-a-pipe sound', 'frictional wheeze', 'squealing inhalation', 'musical chest sound', 'constricted airway melody', 'tiny whistle at exhale', 'squeaking lung pipes', 'scratchy internal whistle', 'hush-like squeal inside chest', 'low whistling hum', 'piping chest note', 'shrilling lung friction', 'wind instrument-like breath', 'wheezy hum inside', 'squeaky balloon-like noise', 'shrill bronchial constriction', 'pinched airway sounds', 'skinny-tube breathing noise', 'fragile airway tone', 'forced narrow-bore breath', 'tight-lung whistle', 'faint flute-like exhale', 'windy squeak in lungs', 'diminished airway diameter sound', 'toy whistle breathing', 'compressed bronchial passage tune'],
    ...
    'cold': ['Common cold', 'head cold', 'mild viral infection', 'slight sniffles', 'catching a cold', 'seasonal cold', 'chest cold', 'light upper respiratory infection', 'mild sniffle bug', 'standard cold virus', 'low-grade nasal virus', 'mild runny-nose ailment', 'basic rhinovirus', 'everyday cold symptoms', 'short-term sniffles', 'routine winter bug', 'easy viral cold', 'minor head stuffiness illness', 'typical seasonal illness'],
    'sweat': ['sweat', 'sweating', 'excessive sweating', 'unusual sweating', 'profuse sweating', 'drenched in sweat', 'perspiring heavily', 'sweating buckets', 'clammy sweating', 'dripping perspiration', 'bead-like sweat on skin', 'moisture streaming down face', 'uncontrollable sweating', 'soaked in sweat', 'overactive sweat glands', 'sweaty and damp skin', 'sweat-soaked clothes', 'constant perspiration', 'sticky sweat', 'salty perspiration', 'glistening with sweat', 'sweat trickling down spine', 'nervous sweating', 'stress-induced sweat', 'drenching perspiration', 'sweat-laden body', 'humid feeling', 'slick skin', 'warm moisture on skin', 'sweat beads forming everywhere', 'bodily moisture overload', 'persistent dampness', 'sweaty palms and forehead', 'rivers of sweat', 'sweat dripping off hairline', 'sweat-soaked sheets', 'nocturnal sweating', 'smelly perspiration', 'standing in a pool of sweat', 'sweat forming under arms', 'shiny perspiring face', 'sweat running down temples', 'sweat-induced chafing', 'slick and slippery feeling', 'sweating like in a steam room', 'permanent dampness', 'sweat stains on clothing'],
    'swelling': ['swollen area', 'inflammation', 'edema'],
    'tremors': ['shaking', 'shivering', 'twitching'],
    'chills': ['Shivering', 'trembling with cold', 'goosebumps', 'feeling cold inside', 'uncontrollable shaking', 'teeth chattering', 'feeling frosty', 'quivering limbs', 'body shaking from cold', 'icy tremors', 'frigid vibrations', 'quaking with chill', 'hair standing on end', 'trembling internally', 'spasmodic shivers', 'cold-induced tremble', 'chilled to the bone', 'freezing sensation', 'vibrating with cold', 'small uncontrollable shakes', 'persistent shuddering', 'subtle shivers', 'prickly gooseflesh', 'frost-like feeling', 'quivery muscles', 'rattled by chill', 'shudders running down spine', 'uncontrollable cold tremors', 'shaky fingers and toes', 'rattling teeth', 'jittering from cold', 'frigid trembles'],
    'dry skin': ['skin dryness', 'rough skin', 'scaly skin'],

    # Different types of pain in specific body parts:
    'eye pain': ['ocular pain', 'eye discomfort', 'pain in the eye'],
    'ear pain': ['earache', 'pain in the ear', 'ear discomfort'],
    'nose pain': ['pain in the nose', 'nasal pain', 'sinus pain'],
    'throat pain': ['sore throat', 'pain in the throat', 'scratchy throat'],
    'jaw pain': ['pain in the jaw', 'jaw discomfort', 'jaw ache'],
    ...
    'wrist pain': ['pain in the wrist', 'wrist discomfort', 'carpal pain'],
    'hand pain': ['hand discomfort', 'pain in the hand', 'aching hand'],
    'arm pain': ['pain in the arm', 'upper limb pain', 'arm discomfort'],
    'leg pain': ['pain in the leg', 'lower limb pain', 'leg discomfort'],
    'confusion' : ['Disorientation', 'muddled thinking', 'mental fog', 'trouble thinking clearly', 'brain fog', 'cognitive cloudiness', 'puzzled state', 'jumbled thoughts', 'incoherent reasoning', 'tangled mental process', 'unclear comprehension', 'befuddled mind', 'scrambled logic', 'perplexed state', 'hazy understanding', 'blurred mental picture', 'fuzzy reasoning', 'perplexity', 'baffled intellect', 'uncertain grasp', 'foggy mental landscape', 'clouded judgment', 'unclear headspace', 'mixed-up thoughts', 'lack of mental clarity', 'distorted perspective', 'murky understanding', 'minds in knots', 'head scrambled eggs feeling', 'no clear thread of thought', 'haphazard reasoning', 'bewildered stance', 'lost mental bearings', 'mental haze', 'unclear mental signals', 'vague cognitive process', 'mental static', 'mentally adrift', 'diluted focus', 'no sharpness in mind', 'blinking confusion', 'unsure mental footing', 'perplexed awareness', 'reduced mental acuity', 'messy mental white noise'],
    ...
    'memory loss' : ['Forgetfulness', 'difficulty recalling', 'poor memory', 'memory lapses', 'amnestic episodes', 'short-term memory issues', 'difficulty remembering recent events', 'blanking out on details', 'slip of the mind', 'fuzzy recollections', 'failing memory', 'losing track of thoughts', 'can’t recall names', 'vacant mental storage', 'holes in memory', 'patchy recollection', 'vanishing details from mind', 'gaps in remembrance', 'fleeting mental notes', 'mental blanks', 'fragmented memory', 'elusive past events', 'stuttering memory', 'hazy recall', 'details fading away', 'mental erasures', 'unstable memory bank', 'shaky recollections', 'selective forgetfulness', 'mental blackouts', 'fuzzy mental snapshots', 'misplacing thoughts', 'memory glitches', 'jumbled recall', 'inability to summon certain facts', 'feeling brain-drained', 'memory going dark', 'fragments of information missing', 'scattering of remembered info', 'ghost-like recollections', 'losing the thread of events', 'names escaping me', 'scrambled memory patterns', 'drifting mental records', 'unreliable mental archives', 'evaporation of recent info', 'dimming recollection', 'disintegrating memory', 'thinning retention', 'leaky mental container', 'short-circuited memory', 'mental fade-outs', 'mental sputtering', 'forgetting simple things', 'intangible memories slipping away', 'memory weakening over time', 'groping for details', 'elusive truths once known', 'mental book pages going blank', 'unstable mental files', 'dulled memory edges', 'uncertain memory foothold', 'eroded recollections', 'falling out of my mind', 'scattering mental fragments', 'temporary amnesia-like moments', 'no access to recent thoughts', 'memory wires disconnected', 'stuttering recollection attempts', 'defragmented mental records', 'shaky mental camera', 'fading mental impressions', 'mind like a sieve', 'losing info instantly', 'rattled mental library', 'concept slip-through', 'flickering data in mind', 'barren mental shelves', 'no retrieval of recent facts', 'thinking it’s on the tip of my tongue but never surfacing', 'losing track of recent conversations', 'difficulty holding new info', 'memory short-circuits frequently', 'mental vacancy', 'ephemeral recollections', 'passing mental clouds with no retention', 'drifting away from details', 'no anchor to past events'],
    'hallucination': ['Seeing things not there', 'hearing nonexistent voices', 'visual distortions', 'auditory hallucinations', 'phantom visions', 'unreal sounds', 'imaginary figures', 'false perceptions', 'sensory fabrications', 'illusory sights', 'ghostly whispers', 'shadowy apparitions', 'non-existent stimuli', 'voices in empty rooms', 'flickers of light not real', 'feeling a presence that’s not there', 'spectral images', 'mind-generated sounds', 'invisible people speaking', 'dreamlike illusions while awake', 'warped reality', 'bending senses', 'tricked by my own brain', 'nonexistent movements in peripheral vision', 'echoing voices in silence', 'flickering shapes without substance', 'disembodied murmurs', 'whispering shadows', 'imaginary footsteps', 'silent rooms speaking to me', 'patterns dancing before eyes', 'unfounded smells wafting in air', 'illusions replacing reality', 'phantasmal scenarios', 'unreal apparitions crossing my vision', 'silent calls of my name', 'mysterious lights floating about', 'feeling touches that never happened', 'spectral whispering', 'sensory deceptions', 'ephemeral figments', 'contorted sensory messages', 'mock stimuli haunting senses', 'invisible entities interacting', 'distorted fields of perception', 'shimmering visions that vanish', 'phantom animals or people', 'synthetic sensory experiences', 'misinterpreted stimuli turning into vivid illusions', 'self-created sensations', 'intangible presences', 'chimerical images', 'hallucinated conversations', 'phantom tunes with no source', 'empty environment filled with false cues', 'conjured voices echoing in mind', 'imaginary visuals like mirages', 'surreal interferences with reality', 'ghostly illusions hovering at edges of sight', 'faint melodies with no origin', 'ephemeral flickers at corner of eye', 'dream fragments leaking into wakefulness', 'morphing shapes in normal objects', 'scrambled sensory data producing false images', 'intangible whispers floating through mind', 'unrealistic tactile sensations', 'intangible phantom touches', 'nonexistent footsteps following', 'made-up voices conversing', 'layered illusions over real world', 'hallucinated colors or patterns', 'nonexistent entities talking or moving', 'conjured-up scenes playing in mind’s eye', 'extended illusions blending with actual scenery'],
}
